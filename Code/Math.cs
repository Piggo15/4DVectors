...
public class Math
{
    ...
    public static float CosineRad(float value)
    {
        ...
        return 1 - value * value / 2 + value * value * value * value / 24 -
               value * value * value * value * value * value / 720;
    }
    ...
    public static float CosineDeg(float value)
    {
        value *= (float.Pi / 180);
        // Using taylor's series, will be accurate to decimal places
        return 180 / float.Pi * (1 - value * value / 2 + value * value * value * value / 24 -
                                 value * value * value * value * value * value / 720);
    }
    ...
    public static float SineRad(float value)
    {
        ...
        return value - value * value * value / 6 + value * value * value * value * value / 120 -
               value * value * value * value * value * value * value / 5040;
    }
    ...
    public static float SineDeg(float value)
    {
        value *= (float.Pi / 180);
        // Using taylor's series, will be accurate to decimal places
        return 180 / float.Pi * (value - value * value * value / 6 + value * value * value * value * value / 120 -
                                 value * value * value * value * value * value * value / 5040);
    }
    ...
    public static float ArccosineDeg(float value)
    {
        ...
        {
            prevApprox = approx;
            approx += CosineDeg(approx) / -SineDeg(approx);
            if (AbsoluteValue(approx - prevApprox) < accuracy)
                return approx;
        }
